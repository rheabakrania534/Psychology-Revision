...
import SwiftUI
struct SocialInfluenceSAView: View {
    ...
    var body: some View {
        ...
        ScrollView {
            ...
            VStack(spacing: 1.0) {
                ...
                Group {
                    VStack {
                        Text(SocialInfluenceSA[questionIndex].question)
                ...
                HStack(spacing: 15) {
                    ForEach(0..<button.count, id: \.self) {button in
                        Button {
                            ...
                            if SocialInfluenceSA.count > questionIndex + 1 {
                                questionIndex += 1
                            }
                        } label: {
                            ...
                            ZStack {
                                ...
                                if questionIndex == 2 {
                                    NavigationLink("Confirm Answer", destination: SocialInfluenceLAView())
                                    .foregroundColor(.white)}
...
struct SocialInfluenceSAView_Previews: PreviewProvider {
    static var previews: some View {
        SocialInfluenceSAView()
