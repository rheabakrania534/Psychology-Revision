...
import SwiftUI
struct SchizophreniaSAView: View {
    ...
    var body: some View {
        ...
        ScrollView {
            ...
            VStack(spacing: 1.0) {
                ...
                Group {
                    VStack {
                        Text(SchizophreniaSA[questionIndex].question)
                ...
                HStack(spacing: 15) {
                    ForEach(0..<button.count, id: \.self) {button in
                        Button {
                            ...
                            if SchizophreniaSA.count > questionIndex + 1 {
                                questionIndex += 1
                            }
                        } label: {
                            ...
                            ZStack {
                                ...
                                if questionIndex == 2 {
                                    NavigationLink("Confirm Answer", destination: SchizophreniaLAView())
                                    .foregroundColor(.white)}
...
struct SchizophreniaSAView_Previews: PreviewProvider {
