    ...
    var body: some View {
        ...
        ScrollView {
            ...
            VStack(spacing: 1.0) {
                ...
                Group {
                    VStack {
                        Text(ResearchSA[questionIndex].question)
                ...
                HStack(spacing: 15) {
                    ForEach(0..<button.count, id: \.self) {button in
                        Button {
                            ...
                            if ResearchSA.count > questionIndex + 1 {
                                questionIndex += 1
                            }
                        } label: {
                            ...
                            ZStack {
                                ...
                                if questionIndex == 2 {
                                    NavigationLink("Confirm Answer", destination: ResearchLAView())
                                    .foregroundColor(.white)}
...
struct ResearchSAView_Previews: PreviewProvider {
