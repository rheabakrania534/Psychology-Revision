...
import SwiftUI
struct IssuesandDebatesSAView: View {
    ...
    var body: some View {
        ...
        ScrollView {
            ...
            VStack(spacing: 1.0) {
                ...
                Group {
                    VStack {
                        Text(IssuesandDebatesSA[questionIndex].question)
                ...
                HStack(spacing: 15) {
                    ForEach(0..<button.count, id: \.self) {button in
                        Button {
                            ...
                            if IssuesandDebatesSA.count > questionIndex + 1 {
                                questionIndex += 1
                            }
                        } label: {
                            ...
                            ZStack {
                                ...
                                if questionIndex == 2 {
                                    NavigationLink("Confirm Answer", destination: IssuesandDebatesLAView())
                                    .foregroundColor(.white)}
...
struct IssuesandDebatesSAView_Previews: PreviewProvider {
    static var previews: some View {
        IssuesandDebatesSAView()
