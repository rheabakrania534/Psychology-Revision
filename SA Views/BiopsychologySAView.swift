...
import SwiftUI
struct BiopsychologySAView: View {
    ...
    var body: some View {
        ...
        ScrollView {
            ...
            VStack(spacing: 1.0) {
                ...
                Group {
                    VStack {
                        Text(BiopsychologySA[questionIndex].question)
                ...
                HStack(spacing: 15) {
                    ForEach(0..<button.count, id: \.self) {button in
                        Button {
                            ...
                            if BiopsychologySA.count > questionIndex + 1 {
                                questionIndex += 1
                            }
                        } label: {
                            ...
                            ZStack {
                                ...
                                if questionIndex == 2 {
                                    NavigationLink("Confirm Answer", destination: BiopsychologyLAView())
                                    .foregroundColor(.white)}
...
struct BipsychologySAView_Previews: PreviewProvider {
