...
import SwiftUI
struct PsychopathologySAView: View {
    ...
    var body: some View {
        ...
        ScrollView {
            ...
            VStack(spacing: 1.0) {
                ...
                Group {
                    VStack {
                        Text(PsychopathologySA[questionIndex].question)
                ...
                HStack(spacing: 15) {
                    ForEach(0..<button.count, id: \.self) {button in
                        Button {
                            ...
                            if PsychopathologySA.count > questionIndex + 1 {
                                questionIndex += 1
                            }
                        } label: {
                            ...
                            ZStack {
                                ...
                                if questionIndex == 2 {
                                    NavigationLink("Confirm Answer", destination: PsychopathologyLAView())
                                    .foregroundColor(.white)}
...
struct PsychopathologySAView_Previews: PreviewProvider {
    static var previews: some View {
        PsychopathologySAView()
