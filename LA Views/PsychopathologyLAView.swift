...
import SwiftUI
struct PsychopathologyLAView: View {
    ...
    var body: some View {
        ...
        ScrollView {
            ...
            VStack(spacing: 1.0) {
                ...
                Group {
                    VStack {
                        Text(PsychopathologyLA[questionIndex].question)
                ...
                HStack(spacing: 15) {
                    ForEach(0..<button.count, id: \.self) {button in
                        Button {
                            ...
                            if PsychopathologyLA.count > questionIndex + 1 {
                                questionIndex += 1
                            }
                        } label: {
                            ZStack {
...
struct PsychopathologyLAView_Previews: PreviewProvider {
    static var previews: some View {
        PsychopathologyLAView()
