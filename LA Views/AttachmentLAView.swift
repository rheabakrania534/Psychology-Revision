    ...
    var body: some View {
        ...
        ScrollView {
            ...
            VStack(spacing: 1.0) {
                ...
                Group {
                    VStack {
                        Text(AttachmentLA[questionIndex].question)
                ...
                HStack(spacing: 15) {
                    ForEach(0..<button.count, id: \.self) {button in
                        Button {
                            ...
                            if AttachmentLA.count > questionIndex + 1 {
                                questionIndex += 1
                            }
                        } label: {
                            ZStack {
...
struct AttachmentLAView_Previews: PreviewProvider {
