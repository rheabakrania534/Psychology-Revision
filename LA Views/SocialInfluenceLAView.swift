...
import SwiftUI
struct SocialInfluenceLAView: View {
    ...
    var body: some View {
        ...
        ScrollView {
            ...
            VStack(spacing: 1.0) {
                ...
                Group {
                    VStack {
                        Text(SocialInfluenceLA[questionIndex].question)
                ...
                HStack(spacing: 15) {
                    ForEach(0..<button.count, id: \.self) {button in
                        Button {
                            ...
                            if SocialInfluenceLA.count > questionIndex + 1 {
                                questionIndex += 1
                            }
                        } label: {
                            ZStack {
...
struct SocialInfluenceLAView_Previews: PreviewProvider {
    static var previews: some View {
        SocialInfluenceLAView()
