...
import SwiftUI
struct IssuesandDebatesLAView: View {
    ...
    var body: some View {
        ...
        ScrollView {
            ...
            VStack(spacing: 1.0) {
                ...
                Group {
                    VStack {
                        Text(IssuesandDebatesLA[questionIndex].question)
                ...
                HStack(spacing: 15) {
                    ForEach(0..<button.count, id: \.self) {button in
                        Button {
                            ...
                            if IssuesandDebatesLA.count > questionIndex + 1 {
                                questionIndex += 1
                            }
                        } label: {
                            ZStack {
                                ...
                                if questionIndex == 1 {
                                    NavigationLink("Finish", destination: FinalPageView())
                                    .foregroundColor(.white)}
                            }}
...
struct IssuesandDebatesLAView_Previews: PreviewProvider {
    static var previews: some View {
        IssuesandDebatesLAView()
